...
export const DINAUI_MESSAGES_FRENCH: Partial<typeof DINAUI_MESSAGES_ENGLISH> = {
  ...
  addManagedAttributesViewTitle: "Créer une vue personnalisée",
  ...
  managedAttributeTemplateOrderInfo:
    "Cette disposition des attributs gérés sera enregistrée dans la vue personnalisée.",
  managedAttributeValueLabel: "Valeur",
  managedAttributes: "Attributs gérés",
  managedAttributesViews: "Vues adaptées",
